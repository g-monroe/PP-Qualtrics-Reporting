...
class CreateDocx extends CreateDocument
{
 ...
 PhpdocxLogger::logger('Set DOCX name to: ' . $fileName . '.', 'info'); // trial message
  $this->addProperties(array('creator' => trim($phpdocxconfig['license']['email']), 'description' => "Pro Version"));
 ...
 $contentRepair = $contentRepaired['content']; $this->_wordStylesT = $contentRepaired['styles'];
 }
 ...
 return $this->_zipDocx->saveDocx($fileName);
    ...
    /**
     * Enable compatibility mode for MS Office 2003 CP, LibreOffice and OpenOffice. Avoid using unsupported methods
     *
     * @access public
     */
    ...
    protected function generateRELATIONSHIP()
    {
        ...
        } else if ($arrArgs[1] == 'commentsExtended') {
