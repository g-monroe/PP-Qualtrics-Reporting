...
! function(n) {
    ...
    w.FE.LinkRegExCommon = "[a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_.]{1,}", w.FE.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;/~+#-\\'*-_{}]*)|())", w.FE.LinkRegExTLD = "((" + w.FE.LinkRegExCommon + ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))", w.FE.LinkRegExHTTP = "((ftp|http|https):\\/\\/" + w.FE.LinkRegExCommon + ")", w.FE.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@" + w.FE.LinkRegExCommon + ")", w.FE.LinkRegExWWW = "(www\\." + w.FE.LinkRegExCommon + "\\.[a-z0-9-]{2,24})", w.FE.LinkRegEx = "(" + w.FE.LinkRegExTLD + "|" + w.FE.LinkRegExHTTP + "|" + w.FE.LinkRegExWWW + "|" + w.FE.LinkRegExAuth + ")" + w.FE.LinkRegExEnd, w.FE.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], w.FE.MAIL_REGEX = /.+@.+\..+/i, w.FE.MODULES.helpers = function(i) {
        ...
        function n(e) {
            ...
            if (!l.core.hasFocus() && e) {
                ...
                if (l.browser.msie && l.$box && l.$box.css("position", "fixed"), l.browser.msie && l.$wp && l.$wp.css("overflow", "visible"), s(), l.$el.focus(), l.events.trigger("focus"), i(), l.browser.msie && l.$box && l.$box.css("position", ""), l.browser.msie && l.$wp && l.$wp.css("overflow", "auto"), n != l.$win.scrollTop() && l.$win.scrollTop(n), !l.selection.info(l.el).atStart) return !1
            }
        ...
        function i(e, t) {
            ...
            for (r.setAttribute("id", "fr-sel-markers"), r.innerHTML = w.FE.MARKERS; S.opts.htmlAllowedEmptyTags && 0 <= S.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());) e = e.parentNode;
            e.appendChild(r);
    ...
    }), w.FE.MODULES.paste = function(y) {
        var N, a, C, o, A;

        function n(e, t) {
            try {
                y.win.localStorage.setItem("fr-copied-html", e), y.win.localStorage.setItem("fr-copied-text", t)
            } catch (n) {}
        }

        function e(e) {
            var t = y.html.getSelected();
            n(t, w("<div>").html(t).text()), "cut" == e.type && (y.undo.saveStep(), setTimeout(function() {
                y.selection.save(), y.html.wrap(), y.selection.restore(), y.events.focus(), y.undo.saveStep()
            }, 0))
        }
        var i = !1;
        ...
        function r(e) {
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (N = "", /text\/rtf/.test(t) && (a = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? N = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && y.browser.safari ? N = a : /text\/plain/.test(t) && !this.browser.mozilla && (N = y.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== N) {
                    y.keys.forceUndo(), A = y.snapshot.get(), y.selection.save(), y.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-helper");
                    var o = y.markers.insertAtPoint(e);
                    if (y.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), y.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), y.selection.restore(), y.selection.remove(), y.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== o) {
                        var i = y.el.querySelector(".fr-marker");
                        return w(i).replaceWith(w.FE.MARKERS), y.selection.restore(), s(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1
                    }
                } else N = null
            }
        }
        ...
        function x(e) {
            ...
            for (t = 0; t < o.length; t++)(n = o[t]).outerHTML = "<" + (y.html.defaultTag() || "DIV") + ">" + n.innerHTML + "</" + (y.html.defaultTag() || "DIV") + ">";
            ...
            var i = function(e) {
                for (var t = y.node.contents(e), n = 0; n < t.length; n++) t[n].nodeType != Node.TEXT_NODE && t[n].nodeType != Node.ELEMENT_NODE ? t[n].parentNode.removeChild(t[n]) : i(t[n])
            };
            return i(r), r.innerHTML
        }

        function s() {
            y.browser.edge && y.opts.iframe && y.$box.after(o), A || (y.keys.forceUndo(), A = y.snapshot.get()), N || (N = o.get(0).innerHTML, y.selection.restore(), y.events.enableBlur());
            var e = N.match(/(class=\"?Mso|class=\'?Mso|class="?Xl|class='?Xl|class=Xl|style=\"[^\"]*\bmso\-|style=\'[^\']*\bmso\-|w:WordDocument)/gi),
                t = y.events.chainTrigger("paste.beforeCleanup", N);
            t && "string" == typeof t && (N = t), (!e || e && !1 !== y.events.trigger("paste.wordPaste", [N])) && l(N, e)
        }
        ...
        function l(r, e, t) {
            ...
            if (!e && (c = function(e) {
                    var t = null;
                    try {
                        t = y.win.localStorage.getItem("fr-copied-text")
                    } catch (n) {}
                    return !(!t || w("<div>").html(e).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != t.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
                }(r), f = function() {
                    var e = null;
                    try {
                        e = y.win.localStorage.getItem("fr-dragged-content-text")
                    } catch (t) {}
                    return !(!e || w("<div>").html(N).text().replace(/\u00A0/gi, " ").replace(/\r|\n/gi, "") != e.replace(/\u00A0/gi, " ").replace(/\r|\n/gi, ""))
                }(), c && (r = y.win.localStorage.getItem("fr-copied-html")), f && (c = !0, r = y.win.localStorage.getItem("fr-dragged-content-html")), !c)) {
                var p = y.opts.htmlAllowedStyleProps;
                y.opts.htmlAllowedStyleProps = y.opts.pasteAllowedStyleProps, y.opts.htmlAllowComments = !1, r = (r = (r = r.replace(/<span class="Apple-tab-span">\s*<\/span>/g, $(y.opts.tabSpaces || 4))).replace(/<span class="Apple-tab-span" style="white-space:pre">(\t*)<\/span>/g, function(e, t) {
                    return $(t.length * (y.opts.tabSpaces || 4))
                })).replace(/\t/g, $(y.opts.tabSpaces || 4)), r = y.clean.html(r, y.opts.pasteDeniedTags, y.opts.pasteDeniedAttrs), y.opts.htmlAllowedStyleProps = p, y.opts.htmlAllowComments = !0, r = (r = (r = O(r)).replace(/\r/g, "")).replace(/^ */g, "").replace(/ *$/g, "")
            }!e || y.wordPaste && t || (0 === (r = r.replace(/^\n*/g, "").replace(/^ /g, "")).indexOf("<colgroup>") && (r = "<table>" + r + "</table>"), r = O(r = function(e) {
                var t;
                ...
                for (e = (e = (e = e.replace(/&nbsp;/gi, " ")).replace(/<td([^>]*)><\/td>/g, "<td$1><br></td>")).replace(/<th([^>]*)><\/th>/g, "<th$1><br></th>");
                    (e = (n = e).replace(/<[^\/>][^>]*><\/[^>]+>/gi, "")) != n;);
                e = (e = e.replace(/<lilevel([^1])([^>]*)>/gi, '<li data-indent="true"$2>')).replace(/<lilevel1([^>]*)>/gi, "<li$1>"), e = (e = (e = y.clean.html(e, y.opts.pasteDeniedTags, y.opts.pasteDeniedAttrs)).replace(/<a>(.[^<]+)<\/a>/gi, "$1")).replace(/<br> */g, "<br>");
                var i = y.o_doc.createElement("div");
                i.innerHTML = e;
                ...
                return y.html.cleanBlankSpaces(i), e = i.innerHTML
            }(r))), y.opts.pastePlain && !c ? r = x(r) : C && r && (r = x(r), C = !1);
            var u = y.events.chainTrigger("paste.afterCleanup", r);
            if ("string" == typeof u && (r = u), "" !== r) {
                var g = y.o_doc.createElement("div");
                0 <= (g.innerHTML = r).indexOf("<body>") ? (y.html.cleanBlankSpaces(g), y.spaces.normalize(g, !0)) : y.spaces.normalize(g);
                ...
                var E = y.selection.element(),
                    v = !1;
                if (E && w(E).parentsUntil(y.el, "ul, ol").length && (v = !0), v) {
                    var b = g.children;
                    1 == b.length && 0 <= ["OL", "UL"].indexOf(b[0].tagName) && (b[0].outerHTML = b[0].innerHTML)
                }
                if (!d) {
                    var S = g.getElementsByTagName("br");
                    for (n = S.length - 1; 0 <= n; n--) {
                        var T = S[n];
                        y.node.isBlock(T.previousSibling) && T.parentNode.removeChild(T)
                    }
                }
                if (y.opts.enter == w.FE.ENTER_BR)
                    for (n = (o = g.querySelectorAll("p, div")).length - 1; 0 <= n; n--) 0 === (i = o[n]).attributes.length && (i.outerHTML = i.innerHTML + (i.nextSibling && !y.node.isEmpty(i) ? "<br>" : ""));
                else if (y.opts.enter == w.FE.ENTER_DIV)
                    for (n = (o = g.getElementsByTagName("p")).length - 1; 0 <= n; n--) 0 === (i = o[n]).attributes.length && (i.outerHTML = "<div>" + i.innerHTML + "</div>");
                else y.opts.enter == w.FE.ENTER_P && 1 == g.childNodes.length && "P" == g.childNodes[0].tagName && 0 === g.childNodes[0].attributes.length && (g.childNodes[0].outerHTML = g.childNodes[0].innerHTML);
                r = g.innerHTML, c && (r = function(e) {
                    var t, n = y.o_doc.createElement("div");
                    n.innerHTML = e;
                    var r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + w.FE.VOID_ELEMENTS.join("):not(") + "):not(" + y.opts.htmlAllowedEmptyTags.join("):not(") + ")");
                    for (; r.length;) {
                        for (t = 0; t < r.length; t++) r[t].parentNode.removeChild(r[t]);
                        r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(" + w.FE.VOID_ELEMENTS.join("):not(") + "):not(" + y.opts.htmlAllowedEmptyTags.join("):not(") + ")")
                    }
                    return n.innerHTML
                }(r)), y.html.insert(r, !0)
            }
            y.events.trigger("paste.after"), y.undo.saveStep(A), A = null, y.undo.saveStep()
        }
        ...
        function O(e) {
            ...
            for (var r = d(Array.prototype.slice.call(n.querySelectorAll(":scope > div:not([style]), td > div:not([style]), th > div:not([style]), li > div:not([style])"))); r.length;) {
                var o = r[r.length - 1];
                if (y.html.defaultTag() && "div" != y.html.defaultTag()) o.querySelector(y.html.blockTagsQuery()) ? o.outerHTML = o.innerHTML : o.outerHTML = "<" + y.html.defaultTag() + ">" + o.innerHTML + "</" + y.html.defaultTag() + ">";
                else {
        ...
        function c(e) {
            if (e.originalEvent && e.originalEvent.target && e.originalEvent.target.nodeType == Node.TEXT_NODE) try {
                y.win.localStorage.setItem("fr-dragged-content-html", e.originalEvent.dataTransfer.getData("text/html")), y.win.localStorage.setItem("fr-dragged-content-text", e.originalEvent.dataTransfer.getData("text/plain"))
            } catch (t) {}
        }

        function f() {
            y.el.removeEventListener("copy", e), y.el.removeEventListener("cut", e), y.el.removeEventListener("paste", t)
        }
        return {
            _init: function() {
                y.el.addEventListener("copy", e), y.el.addEventListener("cut", e), y.el.addEventListener("paste", t, {
                    capture: !0
                }), y.events.on("drop", r), y.browser.msie && y.browser.version < 11 && (y.events.on("mouseup", function(e) {
                    2 == e.button && (setTimeout(function() {
                        i = !1
                    }, 50), i = !0)
                }, !0), y.events.on("beforepaste", t)), y.events.on("dragstart", c, !0), y.events.on("destroy", f)
            },
