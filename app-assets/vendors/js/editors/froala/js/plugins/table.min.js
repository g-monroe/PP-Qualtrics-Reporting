    ...
    Z.extend(Z.FE.POPUP_TEMPLATES, {
        ...
        function d(e) {
            ...
            for (var s = 1; s <= w.opts.tableInsertMaxSize; s++)
                for (var r = 0; r <= w.opts.tableInsertMaxSize; r++) {
        ...
        function b(e) {
            ...
            if (0 < t.length) {
                ...
                for (l = 0; l < r[a].length; l++)
                    if ("below" == e && a < r.length - 1 && r[a][l] == r[a + 1][l] || "above" == e && 0 < a && r[a][l] == r[a - 1][l]) {
        ...
        function g(e, t, l) {
            ...
            if (e < (t = Math.min(t, f[0].length - 1)))
                for (s = e; s <= t; s++)
                    if (!(e < s && f[0][s] == f[0][s - 1]) && 1 < (n = Math.min(parseInt(f[0][s].getAttribute("colspan"), 10) || 1, t - e + 1)) && f[0][s] == f[0][s + 1])
                        for (i = n - 1, a = 1; a < f.length; a++)
                            if (f[a][s] != f[a - 1][s]) {
                                for (r = s; r < s + n; r++)
                                    if (1 < (o = parseInt(f[a][r].getAttribute("colspan"), 10) || 1) && f[a][r] == f[a][r + 1]) r += i = Math.min(i, o - 1);
        ...
        function m(e, t, l) {
            ...
            if (e < (t = Math.min(t, f.length - 1)))
                for (a = e; a <= t; a++)
                    if (!(e < a && f[a][0] == f[a - 1][0]) && 1 < (n = Math.min(parseInt(f[a][0].getAttribute("rowspan"), 10) || 1, t - e + 1)) && f[a][0] == f[a + 1][0])
                        for (i = n - 1, s = 1; s < f[0].length; s++)
                            if (f[a][s] != f[a][s - 1]) {
                                for (r = a; r < a + n; r++)
                                    if (1 < (o = parseInt(f[r][s].getAttribute("rowspan"), 10) || 1) && f[r][s] == f[r + 1][s]) r += i = Math.min(i, o - 1);
                                    else if (!(i = Math.max(0, i - 1))) break;
                                if (!i) break
                            }
        ...
        function v(e, t, l, a, s, r, n) {
            var o, i, f;
            for (o = a; o <= s; o++)
                for (i = r; i <= n; i++) a < o && e[o][i] == e[o - 1][i] || r < i && e[o][i] == e[o][i - 1] || 1 < (f = parseInt(e[o][i].getAttribute(l), 10) || 1) && (1 < f - t ? e[o][i].setAttribute(l, f - t) : e[o][i].removeAttribute(l))
        }
        ...
        function O(e) {
            ...
            return null == (e = e || null) && 0 < J().length && (e = Q()), e && e.find("tr:visible").not(e.find("table tr")).each(function(o, e) {
                ...
                t.find("> th, > td").each(function(e, t) {
                    for (var l = Z(t), a = parseInt(l.attr("colspan"), 10) || 1, s = parseInt(l.attr("rowspan"), 10) || 1, r = o; r < o + s; r++)
                        for (var n = i; n < i + a; n++) f[r] || (f[r] = []), f[r][n] ? i++ : f[r][n] = t;
                    i += a
                })
            }), f
        }
        ...
        function _(t, l) {
            if (Z(t).is(l)) D(), Z(t).addClass("fr-selected-cell");
                ...
                for (var o = n.min_i; o <= n.max_i; o++)
                    for (var i = n.min_j; i <= n.max_j; i++) Z(a[o][i]).addClass("fr-selected-cell")
            }
        }
        ...
        function e(e) {
            ...
            if (0 < J().length && !t && T(), !w.edit.isDisabled() || w.popups.isVisible("table.edit"))
                if (1 != e.which || 1 == e.which && w.helpers.isMac() && e.ctrlKey)(3 == e.which || 1 == e.which && w.helpers.isMac() && e.ctrlKey) && t && T();
                else if (r = !0, t) {
                            ...
                            if (e !== t) {
                                ...
                                if (w.undo.canDo() || w.undo.saveStep(), null !== l && null !== a) {
                                    ...
                                    for (n = 0; n < f.length; n++)
                                        if (o = Z(f[n][l]), i = Z(f[n][a]), f[n][l] != f[n][a]) {
        ...
        function X(e) {
            if (1 < J().length && r && y(), !1 === r && !1 === s && !1 === E) n && clearTimeout(n), w.edit.isDisabled() && !w.popups.isVisible("table.edit") || (n = setTimeout(Y, 30, e));
            else if (E) {
        ...
        return {
            ...
            deleteRow: function() {
                ...
                if (0 < e.length) {
                    var t, l, a, s = O(),
                        r = $(s);
                    if (0 === r.min_i && r.max_i == s.length - 1) u();
                    else {
            ...
            deleteColumn: function() {
                ...
                if (0 < e.length) {
                    var t, l, a, s = O(),
                        r = $(s);
                    if (0 === r.min_j && r.max_j == s[0].length - 1) u();
                    else {
                        var n = 0;
                        for (t = 0; t < s.length; t++)
                            for (l = 0; l < s[0].length; l++)(a = Z(s[t][l])).hasClass("fr-selected-cell") || (a.data("old-width", a.outerWidth() / e.outerWidth() * 100), (l < r.min_j || l > r.max_j) && (n += a.outerWidth() / e.outerWidth() * 100));
                        for (n /= s.length, l = r.max_j; l >= r.min_j; l--)
                            for (t = 0; t < s.length; t++)
            ...
            splitCellHorizontally: function() {
                if (1 == J().length) {
                    ...
                    if (1 < a) {
                        ...
                        for (var i = r.row + o, f = 0 === r.col ? r.col : r.col - 1; 0 <= f && (s[i][f] == s[i][f - 1] || 0 < i && s[i][f] == s[i - 1][f]);) f--; - 1 == f ? Z(l.find("tr").not(l.find("table tr")).get(i)).prepend(n) : Z(s[i][f]).after(n)
                    } else {
                        var c, d = Z("<tr>").append(n);
                        for (c = 0; c < s[0].length; c++)
                            if (0 === c || s[r.row][c] != s[r.row][c - 1]) {
                                var p = Z(s[r.row][c]);
